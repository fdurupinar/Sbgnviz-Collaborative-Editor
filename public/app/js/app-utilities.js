...
appUtilities.updateNetworkTabDesc = function (networkKey) {
  ...
  //There are no 3 child nodes since we have removed the "close tab"
  var relatedTabTextField = relatedTab.childNodes[0];
...
appUtilities.createNewNetwork = function (networkIdParam) {
  ...
  // cwc-change: choose the network id here and use it instead of
  // appUtilities.nextNetworkId at the rest of this function
...
appUtilities.closeOtherNetworks = function (networkId) {
    ...
    for ( var i = 0; i <  networkIdsStack.length; i++) {
        ...
        // close the networks except networkId
