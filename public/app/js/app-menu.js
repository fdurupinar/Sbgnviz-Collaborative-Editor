...
appUtilities = window.appUtilities = require('./app-utilities'); //cwc-change made this global
var appUndoActionsFactory = require('./app-undo-actions-factory');
var modeHandler = require('./app-mode-handler');
var keyboardShortcuts = require('./keyboard-shortcuts');
inspectorUtilities = window.inspectorUtilities = require('./inspector-utilities'); //cwc-change made this global
var collaborativeBackboneViews = require("../../collaborative-app/js/newt-functions/collaborative-backbone-views.js"); //cwc-change
...
module.exports = function() {
  ...
  function loadSample(filename) {
    ...
    // validateSBGNML(textXml); // cwc-change
  ...
  // pathsBetweenQueryView = appUtilities.pathsBetweenQueryView = new BackboneViews.PathsBetweenQueryView({el: '#query-pathsbetween-table'}); //cwc-change
  ...
  // pathsByURIQueryView = appUtilities.pathsByURIQueryView = new BackboneViews.PathsByURIQueryView({el: '#query-pathsbyURI-table'}); //cwc-change
  ...
  collaborativePathsBetweenQueryView = new collaborativeBackboneViews.PathsBetweenQueryView({el: '#query-pathsbetween-table'});//cwc-change--use collaborative version
  collaborativePathsByURIQueryView = new collaborativeBackboneViews.PathsByURIQueryView({el: '#query-pathsbyURI-table'});//cwc-change--use collaborative versi
  ...
  function toolbarButtonsAndMenu() {
    ...
    //cwc-change: they are updated in editor-listener.js
...
//      }
   ...
   $("#export-as-sbml").click(function (evt) {
    ...
    $(document).on('shown.bs.tab', '#network-tabs-list  a[data-toggle="tab"]', function (e) {
      ...
      $("#defaultOpen")[0].click(); //cwc-change: make sure networks tab is active
      $('#network-tabs-list a[href="' + target + '"]').trigger('click'); //cwc-change reclick this
